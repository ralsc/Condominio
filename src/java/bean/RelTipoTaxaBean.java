...
@ManagedBean(name = "relTipoTaxaBean")
@ViewScoped
public class RelTipoTaxaBean implements Serializable {
    ...
    public void gerarRelatorio() throws Exception {
        try {			
            ...
            String url = "/jasper/MA_TipoTaxa.jasper";

            RelatorioUtil.gerarRelatorio(this.getTipo()+".pdf", dataSource, parametros, url);
        } catch (Exception e) {
            e.printStackTrace();
